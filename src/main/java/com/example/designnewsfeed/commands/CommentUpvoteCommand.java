...
@Component
public class CommentUpvoteCommand implements Command{
    private AuthController authController;
    private CommentVotesController commentVotesController;

    public CommentUpvoteCommand(AuthController authController, CommentVotesController commentVotesController) {
    ...
    public boolean canExecute(String input, MockHttpSession session) {
        ...
        if(!strs[0].equals(CommandKeywords.commentUpvoteCommand)) return false;
    ...
    public void execute(String input, MockHttpSession session) {
        ...
        createCommentVotesDto.setType(1);
