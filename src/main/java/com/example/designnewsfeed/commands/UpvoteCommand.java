...
public class UpvoteCommand implements Command{
    ...
    public UpvoteCommand(AuthController authController, PostVotesController postVotesController) {
    ...
    public boolean canExecute(String input, MockHttpSession session) {
        ...
        if(!strs[0].equals(CommandKeywords.upvoteCommand)) return false;
